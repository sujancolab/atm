    ...
    submit_machine() {
      this.$validator.validateAll().then(async valid => {
        if (valid) {
          ...
          //       });
          try {
            const response = await axios.post('api/storeComplaint', this.form, {
              headers: {
