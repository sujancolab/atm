...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate() {
    axios.post('api/dashboard', this.search).then(res => {
      ...
      this.barProjectOptions.series = res.data.data.ProjectChart.options.xaxis.categories;
