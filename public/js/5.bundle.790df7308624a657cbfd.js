...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate: function beforeCreate() {
    ...
    axios.get("api/user/1").then(function (res) {
      console.log(res);
      _this.frm_quotes; // this.frm_quotes.fill(res.data.data)
