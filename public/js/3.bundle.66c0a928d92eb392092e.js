  ...
  methods: {
    ...
    submitCloseTicket() {
      ...
      this.$validator.validateAll('closeticket').then(async valid => {
        if (valid) {
          if (this.pop_machine && this.pop_machine.datetime && this.formclose.actual_date && Date.parse(this.formclose.actual_date) < Date.parse(this.pop_machine.datetime)) {
