                ...
                case 0:
                  if (valid) {
                    ...
                    _this3.frm_quotes.post('api/quotes').then(function (data) {
                      cloaderd.hide();
                      _this3.frm_quotes.id = data.data.data.id; // this.frm_user.reset();
