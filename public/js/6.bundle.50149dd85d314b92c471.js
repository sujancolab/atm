      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.get('api/reopen_ticket/' + ticket.id).then(() => {
            Swal.fire('Success!', 'Ticket reopened.', 'success');
                                  ...
                                  _vm.$gate.hasPermission("can_reopen_ticket")
                                    ? _c(
                                        "a",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.reopenTicket(ticket)
                                            }
                                          }
                                        },
                                        [
