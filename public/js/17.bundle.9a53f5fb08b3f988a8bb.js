  ...
  methods: {
    async get_tickets(ticket, x) {
      ...
      axios.post("/api/reports_child", arr).then(res => {
        ...
        this.Tickets.records.data[x].tickets = res.data.data;
        //this.$set(this.Tickets.records.data, x, res.data.data)
      }).catch(err => {
        console.error(err);
      });
    },
