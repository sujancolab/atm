    ...
    submitMaintenance() {
      this.$validator.validate().then(async valid => {
        if (valid) {
          ...
          this.formclose.put('/api/machine/maintenance').then(response => {
