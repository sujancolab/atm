                                  ...
                                  _vm.$gate.hasPermission("can_edit_reading")
                                    ? _c(
                                        "router-link",
                                        {
                                          staticClass: "btn btn-sm btn-primary",
                                          attrs: {
                                            to: "/reading-data/edit" + ticket.id
                                          }
                                        },
                                        [
                                          _vm._v(
