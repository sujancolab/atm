  ...
  methods: {
    ...
    getResults(page = 1) {
      ...
      axios.post("/api/reports", this.search).then(res => {
        ...
        console.log("ticker", this.Tickets);
      }).catch(err => {
        console.error(err);
      });
