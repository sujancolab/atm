...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submit_quote: function submit_quote() {
      ...
      alert("test");
      this.$validator.validateAll('frmStep' + this.step).then( /*#__PURE__*/function () {
