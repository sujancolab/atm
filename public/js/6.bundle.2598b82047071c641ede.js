                            ...
                            ? _c("VueGauge", {
                                attrs: {
                                  ...
                                  options: {
                                    ...
                                    arcDelimiters: [
                                      Number(
                                        Machine.next_pm_date.settings.date_red
                                      ),
                                      Number(
                          ...
                          Machine.next_pm_date.early_type == "km"
                            ? _c("VueGauge", {
                                attrs: {
                                  refid: "lopg" + Machine.id,
                                  options: {
                                    needleValue: Machine.next_pm_date.km_run,
                                    arcDelimiters: _vm.get_del(
                                      ...
                                      Number(
                                        Machine.next_pm_date.settings.km_orange
                                      ),
                                      Number(
                                        Machine.next_pm_date.settings.km_yellow
                                      ),
                                      100
                                    ),
                                    arcColors: [
                          ...
                          Machine.next_pm_date.early_type == "hr"
                            ? _c("VueGauge", {
                                attrs: {
                                  refid: "lopg" + Machine.id,
                                  options: {
                                    needleValue: Machine.next_pm_date.hr_run,
                                    arcDelimiters: _vm.get_del(
                                      ...
                                      Number(
                                        Machine.next_pm_date.settings.hr_orange
                                      ),
                                      Number(
                                        Machine.next_pm_date.settings.hr_yellow
                                      ),
                                      10
                                    ),
                                    arcColors: [
                                ...
                                attrs: {
                                  ...
                                  options: {
                                    ...
                                    arcDelimiters: _vm.get_del(
                                      ...
                                      Number(
                                        Machine.next_pm_date.settings.prdfig_red
                                      ),
                                      Number(
                                        Machine.next_pm_date.settings
                                          .prdfig_orange
