        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                if (n) {
                  $('#frmStep1 .form-control').prop('disabled', true);
                } else {
                  $('#frmStep1 .form-control').prop('disabled', false);
                }
            ...
            switch (_context6.prev = _context6.next) {
              case 0:
                if (n == 'United Scrap Metal') {
                  if (!['Admin', 'USM-Account-Manager', 'CEC', 'USM-Finance', 'USM-Transport'].includes(_this7.frm_user.type)) {
                    _this7.frm_user.type = '';
                  }
                } else {
                  if (!['Customer-Principal', 'Customer-Finance', 'Customer-Transport'].includes(_this7.frm_user.type)) {
                    _this7.frm_user.type = '';
                  }
                }
