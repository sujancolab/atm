...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    get_del(threshold, red, orange, yellow, green) {
      let l = [100 - green, 100 - yellow, 100 - orange];
      console.log('tag', l);
      return l;
      let x = threshold / 30;
