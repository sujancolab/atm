    ...
    submit_user: function submit_user() {
      ...
      if (this.frm_user.id > 0) {
        ...
        this.frm_user.post('api/user').then(function (data) {
          cloaderd.hide();
          _this4.frm_user.id = data.data.id; // this.frm_user.reset();
