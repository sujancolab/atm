          ...
          chart: {
            ...
            events: {
              click: function (event, chartContext, config) {
                var category = chartContext.w.globals.lastXAxis.categories[config.dataPointIndex];
                axios.get('api/get_machine_for_dashboard', {
                  params: {
                    'far_no': category
                  }
                }).then(function (response) {
                  this.far_details = response.data.data.$('#countComplaintModal').modal('show');
