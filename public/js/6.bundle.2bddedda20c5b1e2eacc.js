...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate() {
    axios.post('api/dashboard', this.search).then(res => {
      ...
      this.barEquipmentOptions.chartOptions.xaxis.categories = [...data.ProjectChart.categories];
      this.barProjectOptions.chartOptions.xaxis.categories = data.ProjectChart.map(project => project);
