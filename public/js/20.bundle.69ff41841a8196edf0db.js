...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submitComplaintForm() {
      ...
      this.$http.post(`/complaint/comment/${this.complaint.id}`, formData).then(response => {
        // handle success
      }).catch(error => {
        // handle error
      });
