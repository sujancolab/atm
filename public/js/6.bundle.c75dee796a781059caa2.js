  ...
  beforeCreate: function beforeCreate() {
    ...
    axios.post('/api/password/checkToken', {
      ...
      Swal.fire({
        ...
        if (value) {//  th.$router.push('/login').catch(() => { });
        }
      });
    });
  },
