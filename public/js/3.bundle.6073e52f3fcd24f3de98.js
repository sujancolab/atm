    ...
    'form.stages': {
      handler: function (n, o) {
        if (n && n.length > 0) {
          ...
          if (la.stage_date && la.stage_date != 'null') this.last_stage_date = new Date(la.stage_date).toISOString();
        } else {
