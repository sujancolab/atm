...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getClosingHourmeterValidation(ticket, index) {
      console.log("asd" + index, this.form.reading);
