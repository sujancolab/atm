    ...
    submitCloseTicket() {
      ...
      this.$validator.validateAll('closeticket').then(async valid => {
        if (valid) {
          ...
          console.log(Date.parse(this.formclose.actual_date) + '  -  ' + Date.parse(this.pop_machine.datetime));
          return false;
