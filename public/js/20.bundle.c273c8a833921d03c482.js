  ...
  methods: {
    deleteReading(data) {
      Swal.fire({
        ...
        if (result.value) {
          this.form.delete('api/reading/' + data.id).then(() => {
