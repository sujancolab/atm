...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    calculatePDV(purchase_date, purchase_price, year_of_depreciation) {
      ...
      console.log("per", yeardiff);
      console.log("yod", peryearval * (yeardiff - year_of_depreciation));
      // if(){
