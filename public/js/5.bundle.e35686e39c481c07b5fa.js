                    ...
                    _vm.pmModalData.is_maintenance_date
                      ? _c("VueGauge", {
                          attrs: {
                            ...
                            options: {
                              needleValue:
                                _vm.pmModalData.pmModalData.next_pm_date
                                  .maintenance_date,
                              arcDelimiters: [10, 36, 78],
                              arcColors: ["red", "orange", "yellow", "green"],
                              chartWidth: "80"
                    ...
                    _vm.pmModalData.is_consumtion_km_run
                      ? _c("VueGauge", {
                          attrs: {
                            ...
                            options: {
                              needleValue:
                                _vm.pmModalData.pmModalData.next_pm_date.km_run,
                              arcDelimiters: [10, 36, 78],
                              arcColors: ["red", "orange", "yellow", "green"],
                              chartWidth: "80"
                            }
                    ...
                    _vm.pmModalData.is_consumtion_hr_run
                      ? _c("VueGauge", {
                          attrs: {
                            ...
                            options: {
                              needleValue:
                                _vm.pmModalData.pmModalData.next_pm_date.hr_run,
                              arcDelimiters: [10, 36, 78],
                              arcColors: ["red", "orange", "yellow", "green"],
                              chartWidth: "80"
                            }
