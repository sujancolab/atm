...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    async get_tickets(ticket) {
      let arr = this.search;
      if (this.search == 'machine wise') {
        arr.machine_id = ticket.id;
      }
      if (this.search == 'site wise') {
