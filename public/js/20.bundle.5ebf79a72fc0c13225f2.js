  ...
  methods: {
    deleteReading(reading) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.form.delete('api/reading/' + reading.id).then(() => {
