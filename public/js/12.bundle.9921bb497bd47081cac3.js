    ...
    return {
      ...
      json_fields: {
        ...
        'Last Maintenance Type': {
          field: "last_ticket",
          callback: machine => {
            return machine.last_ticket ? machine.last_ticket.ticket_type : '';
          }
        },
        'Last Maintenance Date': {
          field: "last_ticket",
          callback: machine => {
            return machine.last_ticket ? machine.last_ticket.actual_date : '';
          }
        }
      },
      json_meta: [[{
