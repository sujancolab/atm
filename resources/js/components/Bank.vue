                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(bank, x) in banks.data" :key="bank.id">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btn-sm btn-toggle-custom" @click="editModal(bank)" >Edit</button>
                                        ...
                                        <td v-if="bank.status == 1">
                                            <a href="javascript:void(0);" @click="
                                                changeStatus(bank.id, 0)
                                                " class="">
    ...
    methods: {
        ...
        changeStatus(id, status) {
            ...
            Swal.fire({
                ...
                // Send request to the server
                if (result.value) {
                    axios.post("/api/bank/change-status", { id: id, status: status })
                        .then(res => {
                            Toast.fire({
                                icon: "success",
