                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(client, x) in clients.data" :key="client.id">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btn-sm btn-toggle-custom" @click="editModal(client)" :disabled="!$gate.hasPermission('can_edit_complaint_type')">Edit</button>
                                        ...
                                        <td v-if="client.status==0">Inactive</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
