                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(custodian, x) in custodians.data" :key="custodian.id">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btn-sm btn-toggle-custom" @click="editModal(custodian)">Edit</button>
                                        ...
                                        <td v-if="custodian.status == 1">
                                            <a href="javascript:void(0);" @click="
                                                changeStatus(custodian.id, 0)
                                                " class="">
      ...
      try {
        ...
        changeStatus(id, status) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    axios.post("/api/custodian/change-status", { id: id, status: status })
                        .then(res => {
                            Toast.fire({
                                icon: "success",
