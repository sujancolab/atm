                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>{{ atm.state.name }}</td>
                                        <td>{{ atm.city.city_name }}</td>
                                        <td class="text-capitalize">
                                            {{ atm.postcode.postcode }}
                                        </td>
                                        <td class="text-capitalize">
                                            {{ atm.postcode.area_code }}
                                        </td>
                                        <td class="text-capitalize">
                                            {{ atm.client.client_name }}
                                        </td>
                                        <td class="text-capitalize">
                                            {{ atm.client.client_name }}
                                        </td>
...
export default {
    ...
    methods: {
        async export_csv() {
            const response = await axios.get("api/atm?export=1", {
                params: {
                    search: this.search,
                },
            });
    ...
    beforeCreate() {
        ...
        const clientApi = axios.get("api/getClients");
    ...
    watch: {
                ...
                if (n) {
                    axios
                        ...
                        .then((res) => {
                            ...
                            console.log("after choose postcode: ", this.areacodes);
                        });
                }
            },
        },
        "form.client_id": {
            ...
            handler(n) {
                if (n) {
                    axios
                        .get("api/getClientCode", {
                            params: {
                                client_id: n,
                            },
                        })
                        .then((res) => {
                            this.client_codes = res.data.data;
                            console.log("after choose postcode: ", this.client_codes);
                        });
                }
            },
        },
