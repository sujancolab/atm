                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Area Code List</h3>
                        ...
                        >
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr
                                        v-for="(areacode, x) in areacodes.data"
                                        :key="areacode.id"
                                    >
                                        <td>
                                            <div class="btn-group">
                                        ...
                                        <td class="text-capitalize">
                                            {{ areacode.district.district_name }}
                                        </td>
                                        <td>{{ areacode.state.state_name }}</td>
                                        <td>{{ areacode.city.city_name }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                :class="{
                                                    'is-invalid':
                                                        verrors.has('area_code'),
                                                }"
                                                v-validate="'required'"
                                                data-vv-as="area_code"
                                                :disabled="form.id != ''"
                                            />
                                            <div
                                                v-if="verrors.has('area_code')"
                                                class="help-block invalid-feedback"
                                            >
                                                {{ verrors.first("area_code") }}
                                            </div>
                                        </div>
                                    </div>
