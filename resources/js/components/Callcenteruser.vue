                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(callcenter, x) in callcenters.data" :key="callcenter.id">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btn-sm btn-toggle-custom" @click="editModal(callcenter)" :disabled="!$gate.hasPermission('can_edit_complaint_type')">Edit</button>
